...
<body>
  <div class="header">
    <div>
      <div class="brand">SmritiCare (স্মৃতি কেয়াৰ)</div>
      <div class="subbrand">Cognitive Wellness & Community Geriatric Monitoring • Assam Health Mission</div>
    </div>
  ...
  <div class="patient-card">
    <div>
      ...
      <div class="field-val">${patient.name} (${patient.nameAs})</div>
    </div>
    <div>
    ...
    <div>
      ...
      <div class="field-val">${patient.village} (Titabor)</div>
    </div>
    <div>
    ...
    <div>
      ...
      <div class="field-val">Minoti Das (Titabor Block)</div>
    </div>
    <div>
  ...
  <table>
    ...
    <tbody>
      ${cognitiveTrends.map(trend => {
        ...
        return `
          <tr>
            <td><strong>${trend.domain}</strong><br><span style="color: #64748b; font-size: 11px;">${trend.domainAs}</span></td>
  ...
  <div class="footer">
    <div>Generated by SmritiCare v1.0 (Titabor PHC Roster)</div>
