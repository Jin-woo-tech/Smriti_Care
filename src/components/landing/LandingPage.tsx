...
export const LandingPage: React.FC<LandingPageProps> = ({ onSelectRole }) => {
  const { settings, setRole, setSosOpen } = useApp();
  ...
  const roleCards = [
    {
      ...
      icon: <User size={26} className="text-[#c5f82a]" />,
      badge: 'Senior Mode',
      badgeHi: 'वरिष्ठ मोड',
    ...
    },
    {
      ...
      icon: <Stethoscope size={26} className="text-teal-300" />,
    ...
    },
    {
      ...
      icon: <Activity size={26} className="text-amber-300" />,
      badge: 'Field Portal',
  ...
  return (
    <div className="space-y-12 py-2">
      {/* ========================================================================= */}
      {/* HERO SHOWCASE CONTAINER - EXACT RECREATION OF IMAGE #10 */}
      {/* ========================================================================= */}
      <div className="relative rounded-[32px] sm:rounded-[44px] border-2 border-blue-400/20 bg-gradient-to-b from-[#182d47] via-[#203c5e] to-[#142337] p-5 sm:p-8 md:p-10 shadow-2xl shadow-slate-950/40 text-white overflow-hidden">
        {/* Subtle cybernetic grid pattern overlay matching Image #10 */}
        <div
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-56 bg-sky-400/15 blur-[100px] pointer-events-none rounded-full" />
        <div className="absolute bottom-0 right-10 w-80 h-80 bg-blue-600/15 blur-[120px] pointer-events-none rounded-full" />

        {/* TOP INNER NAVIGATION BAR (Matching Image #10) */}
        <header className="relative z-20 flex items-center justify-between pb-6 sm:pb-8 border-b border-white/10">
          {/* Logo Brand: VitalCare / SmritiCare with Lime Sprout/Heart */}
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-full bg-[#c5f82a] flex items-center justify-center text-slate-950 shadow-md shadow-[#c5f82a]/30">
            ...
            <span className="text-xl sm:text-2xl font-black tracking-tight text-white flex items-center gap-1.5">
              ...
              <span className="text-[10px] uppercase font-mono px-1.5 py-0.5 rounded bg-white/10 text-sky-200 border border-white/10 hidden sm:inline-block">
                SIH 2026
              </span>
            </span>
          </div>

          {/* Centered Navigation Links matching Image #10 */}
          <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-xs font-semibold text-stone-300">
            <button
              ...
              className={`transition-colors cursor-pointer ${
                activeNav === 'home'
                  ? 'text-[#c5f82a] font-black border-b-2 border-[#c5f82a] pb-1'
                  : 'hover:text-white'
              }`}
            >
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-5 sm:px-6 py-2 rounded-full bg-white/10 hover:bg-white/20 border border-white/25 text-white font-bold text-xs sm:text-sm backdrop-blur-md transition-all shadow-lg hover:border-[#c5f82a]/50 cursor-pointer"
            >
        ...
        <div id="hero-main" className="relative pt-6 sm:pt-10 pb-4">
          {/* Giant Typography Background: SMRITI (left) & CARE (right) / HEALTH CARE matching Image #10 */}
          <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex items-center justify-between pointer-events-none select-none z-0 px-2 sm:px-6">
          ...
          {/* Subtitles & Badges on the sides of typography matching Image #10 */}
          <div className="relative z-10 flex flex-wrap items-center justify-between gap-4 mb-2 text-xs sm:text-sm text-sky-100/90 font-medium">
            ...
            <div className="flex items-center gap-2 font-mono text-xs text-sky-200">
              <span>Since</span>
              <span className="text-[#c5f82a] font-bold">⚡ 2026</span>
              <span>• Titabor, Assam</span>
            </div>
          </div>

          {/* Central 3D Glossy Anatomical Heart Artwork with Lime 'Explore Services' Button */}
          ...
          {/* BOTTOM FLOATING FROSTED GLASS CARDS (Matching Image #10) */}
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 items-end pt-4">
            ...
            <div className="flex flex-col items-start gap-2">
              <div className="flex items-center gap-3">
                <div className="flex -space-x-2.5 overflow-hidden">
                  <div className="w-8 h-8 rounded-full bg-teal-400 border-2 border-[#182d47] flex items-center justify-center text-xs font-bold text-slate-900">
                    👵
                  </div>
                  <div className="w-8 h-8 rounded-full bg-sky-400 border-2 border-[#182d47] flex items-center justify-center text-xs font-bold text-slate-900">
                    👴
                  </div>
                  <div className="w-8 h-8 rounded-full bg-amber-400 border-2 border-[#182d47] flex items-center justify-center text-xs font-bold text-slate-900">
                    👩‍⚕️
                  </div>
                  <div className="w-8 h-8 rounded-full bg-emerald-400 border-2 border-[#182d47] flex items-center justify-center text-xs font-bold text-slate-900">
                    🩺
                  </div>
                </div>
              ...
              {/* Vertical connector line with glowing dot matching Image #10 */}
              <div className="flex flex-col items-center pl-4 py-1">
                <div className="w-0.5 h-6 bg-sky-300/40" />
                <div className="w-2 h-2 rounded-full bg-[#c5f82a] shadow-sm shadow-[#c5f82a]" />
              </div>

              {/* Pill badge matching Image #10 */}
            ...
            {/* 2. Center Feature Card: Doctor Spotlight + 92% Satisfaction matching Image #10 */}
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-4 sm:p-5 shadow-2xl flex items-center gap-4 hover:border-white/40 transition-all">
              {/* Doctor Avatar */}
              <div className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-2xl overflow-hidden bg-gradient-to-tr from-sky-600 to-teal-400 shrink-0 border border-white/30">
                <img
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] font-extrabold text-[#c5f82a] tracking-wider uppercase">
                  15+ YEARS EXPERIENCE
                </p>
              </div>
            </div>

            {/* 3. Right Card: Regional Outreach & Glowing 3D Hologram Globe matching Image #10 */}
            <div className="flex flex-col items-start md:items-end justify-between gap-3 text-left md:text-right">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 text-xs font-bold text-[#c5f82a] hover:underline cursor-pointer"
              >
      ...
      <section id="portals-section" className="space-y-6 pt-4">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/10 border border-white/15 text-[#c5f82a] text-xs font-bold backdrop-blur-md">
            <Sparkles size={14} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {roleCards.map(card => (
            <div
              ...
              className="glass-card-dark rounded-[2rem] p-7 hover:border-[#c5f82a]/60 shadow-xl cursor-pointer group flex flex-col justify-between glass-hover-shine"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="w-13 h-13 rounded-2xl bg-white/10 border border-white/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                    {card.icon}
                  </div>
                  <span className="text-xs font-black tracking-wider uppercase px-3.5 py-1 rounded-full bg-[#c5f82a]/15 text-[#c5f82a] border border-[#c5f82a]/30">
                    {getCardBadge(card)}
                  </span>
                </div>

                <h3 className="text-xl font-black text-white mb-2 group-hover:text-[#c5f82a] transition-colors">
                  {getCardTitle(card)}
                </h3>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/10">
                <span className="text-xs font-bold text-[#c5f82a] flex items-center gap-1.5 group-hover:translate-x-1.5 transition-transform">
      ...
      {/* ========================================================================= */}
      {/* SECTION 3: KEY PLATFORM CAPABILITIES & 3D ORGAN DIAGNOSTICS */}
      {/* ========================================================================= */}
      <section id="games-section" className="rounded-[2.5rem] bg-gradient-to-br from-[#122e4d]/90 via-[#1a4470]/80 to-[#0e2742]/90 backdrop-blur-2xl border border-white/20 p-6 sm:p-9 shadow-2xl space-y-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <h3 className="text-xl sm:text-2xl font-black text-white flex items-center gap-2.5">
            <ShieldCheck className="text-[#c5f82a]" size={26} />
            <span>
              {lang === 'as'
          ...
          <span className="text-xs font-black uppercase tracking-wider bg-[#c5f82a] text-slate-950 px-3 py-1 rounded-full shadow-md">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
          {/* Card 1 */}
          <div className="p-6 rounded-[2rem] bg-white/10 backdrop-blur-xl border border-white/15 hover:border-[#c5f82a]/50 hover:bg-white/15 transition-all group glass-hover-shine">
            <div className="w-12 h-12 rounded-2xl bg-teal-500/20 text-teal-300 border border-teal-500/30 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              <Brain size={24} />
            </div>
            <h4 className="font-black text-base text-white group-hover:text-[#c5f82a] transition-colors">
              {lang === 'as' ? '৬ টা অভিযোজিত খেল' : lang === 'hi' ? '6 अनुकूलनीय खेल' : '6 Adaptive Memory Games'}
            </h4>
            <p className="text-xs text-cyan-100/75 mt-2 leading-relaxed font-medium">
              {lang === 'as'
          ...
          {/* Card 2 */}
          <div id="safety-section" className="p-6 rounded-[2rem] bg-white/10 backdrop-blur-xl border border-white/15 hover:border-cyan-400/50 hover:bg-white/15 transition-all group glass-hover-shine">
          ...
          {/* Card 3 */}
          <div className="p-6 rounded-[2rem] bg-white/10 backdrop-blur-xl border border-white/15 hover:border-rose-400/50 hover:bg-white/15 transition-all group glass-hover-shine">
            <div className="w-12 h-12 rounded-2xl bg-rose-500/20 text-rose-300 border border-rose-500/30 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              <HeartHandshake size={24} />
            </div>
            <h4 className="font-black text-base text-white group-hover:text-rose-300 transition-colors">
      ...
      <section className="rounded-2xl bg-amber-500/10 border border-amber-400/30 p-5 text-amber-200 text-xs sm:text-sm leading-relaxed backdrop-blur-md">
        ...
        <p>{getTranslation('clinicalDisclaimer', lang)}</p>
      </section>
    </div>
  );
};
